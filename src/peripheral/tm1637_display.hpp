#ifndef GROWER_CONTROLLER_RPI_TM1637_DISPLAY_HPP
#define GROWER_CONTROLLER_RPI_TM1637_DISPLAY_HPP
...
namespace grower::peripheral {
    ...
    private:
        ...
        wiring::gpio_pin _pin_clk;
        wiring::gpio_pin _pin_dio;

        void delay_bit() const;
...
#endif //GROWER_CONTROLLER_RPI_TM1637_DISPLAY_HPP
